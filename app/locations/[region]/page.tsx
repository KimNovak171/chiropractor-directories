...
export function generateMetadata({
  ...
  return {
    title: `Chiropractic clinics in ${regionCode}`,
    description: `Explore chiropractic clinic options and services in ${regionCode} with ChiropractorDirectories.com.`,
    openGraph: {
      title: `Chiropractic clinics in ${regionCode} | ChiropractorDirectories.com`,
      description: `Browse chiropractic clinic options and services in ${regionCode}.`,
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="space-y-4">
        <p className="text-sm font-medium uppercase tracking-[0.2em] text-teal">
          Chiropractic Clinics by Region
        </p>
        <h1 className="text-3xl font-semibold text-navy">
          Chiropractic clinic options in {regionCode}
        </h1>
        <p className="max-w-2xl text-sm text-slate-600">
          This is a placeholder view for{" "}
          <span className="font-semibold">{regionCode}</span>. Here you&apos;ll
          be able to browse chiropractic clinic services in this state or
          province.
        </p>
