...
export const metadata: Metadata = {
  metadataBase: new URL("https://chiropractordirectories.com"),
  title: {
    default: "ChiropractorDirectories.com | Chiropractor Directory",
    template: "%s | ChiropractorDirectories.com",
  },
  description:
    "ChiropractorDirectories.com is a professional, easy-to-use chiropractic care directory helping patients and families find local chiropractors and chiropractic services across the United States and Canada.",
  alternates: {
    canonical: "/",
  },
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ChiropractorDirectories.com logo preview",
      },
    ],
  },
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-WBD4W4V9LQ"
        />
        <script
        ...
        <div className="flex min-h-screen flex-col bg-surface text-foreground">
            ...
            <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
              <div className="flex items-center gap-6">
                <Link
                  ...
                  aria-label="ChiropractorDirectories.com – go to homepage"
                >
          ...
          <footer className="w-full border-t border-teal/10 bg-surface">
            <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-5 text-xs text-foreground/80 sm:px-6 lg:px-8">
              <p>
                © {new Date().getFullYear()} ChiropractorDirectories.com. For
