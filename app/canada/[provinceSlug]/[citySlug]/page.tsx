      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${cityName}, ${provinceName} chiropractic clinic directory preview`,
        },
      ],
    },
  };
...
export default async function CanadaCityPage({ params }: CanadaCityPageProps) {
  ...
  const webpageSchema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: `Chiropractic Clinics in ${cityName}, ${provinceName}, Canada`,
    ...
    about: [
      { "@type": "Thing", name: `${cityName} chiropractic clinics` },
      { "@type": "Thing", name: `${provinceName} chiropractic services` },
