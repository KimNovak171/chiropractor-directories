      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "ChiropractorDirectories.com homepage preview",
        },
      ],
    },
  };
    ...
    itemListElement: [
      {
        ...
        item: "https://chiropractordirectories.com/",
      },
    ],
  };
  ...
  return (
    <div className="bg-surface text-foreground">
      ...
      <p className="mx-auto max-w-2xl rounded-lg border-2 border-teal/40 bg-surface px-4 py-3 text-center text-sm text-slate-700">
        Chiropractic clinic owners: Get featured at the top of your city listing.{" "}
        <Link
          href="/advertise"
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-xl border-l-4 border-teal border border-surface-muted bg-surface p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Compare local options by city with ratings, chiropractic services,
                and contact details.
              </p>
            </div>
            <div className="rounded-xl border-l-4 border-teal border border-surface-muted bg-surface p-5 shadow-sm">
